...
export default function AssistantsPage() {
  ...
  const [firstMessageTouched, setFirstMessageTouched] = useState(false);
  ...
  }, [formData.name, formData.callDirection, editingAssistant, businessName, businessLanguage, firstMessageTouched, isTextMode]);
  ...
  const handlePurposeChange = (purpose) => {
    setFormData(prev => ({
      ...
      firstMessage: firstMessageTouched ? prev.firstMessage : getDefaultFirstMessage('outbound', prev.name),
    }));
  };
                ...
                return (
                  <tr key={assistant.id} className={getDashboardRowHoverClass(dark)}>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-center">
                      <div className="grid min-h-8 grid-cols-3 items-center justify-items-center gap-1">
