...
const entries = [
  {
    ...
    dateTR: 'Haziran 2026',
    dateEN: 'June 2026',
    titleTR: 'Arama Desteği & Daha Hızlı Erişim',
    titleEN: 'Search Support & Faster Retrieval',
    descTR: 'Bilgi tabanı ve konuşma geçmişinde gelişmiş arama desteği eklendi. Ekipleriniz ihtiyaç duyduğu içeriklere daha hızlı ve net şekilde ulaşabilsin.',
    descEN: 'Added advanced search support across the knowledge base and conversation history so teams can reach the right content faster.',
    ...
    changes: [
      ...
      { type: 'improvement', textTR: 'Sonuçlara daha hızlı erişim akışı', textEN: 'Faster access flow for search results' },
    ],
  },
  {
    version: 'v0.5.0',
  ...
  },
  {
    ...
    titleTR: '\u0130lk Ad\u0131m',
    titleEN: 'First Step',
    descTR: 'Telyx\u2019in temelleri at\u0131ld\u0131. AI asistan olu\u015Fturma, bilgi taban\u0131 ve temel chat deneyimi ile yolculu\u011Fa ba\u015Flad\u0131k.',
    descEN: 'The foundations of Telyx were laid. We started the journey with AI assistant creation, knowledge base and a basic chat experience.',
